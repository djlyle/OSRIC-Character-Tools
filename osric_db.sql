...
--
-- Host: localhost
-- Generation Time: Jan 30, 2016 at 12:36 PM
...
('Block and tackle		', 5, 5, 8, 0),
('Boots,soft			', 3, 1, 9, 0),
('Boots,heavy		', 5, 2, 10, 0),
('Bottle (wine), glass		', 1, 2, 11, 0),
('Box (empty)		', 15, 1, 12, 0),
('Bracer, leather (archery)	', 1, 0.8, 13, 0),
('Caltrops			', 2, 1, 14, 0),
('Candle, beeswax		', 0, 0.01, 15, 0),
('Canvas			', 1, 0.1, 16, 0),
('Cauldron and tripod		', 15, 2, 17, 0),
('Chain (per 10 ft)		', 10, 30, 18, 0),
('Chalk, piece		', 0, 0.01, 19, 0),
('Chest (empty)		', 25, 2, 20, 0),
('Cloak			', 2, 0.03, 21, 0),
('Crowbar			', 5, 2, 22, 0),
('Dice, bone, pair		', 0, 0.5, 23, 0),
('Dice, loaded, pair		', 0, 5, 24, 0),
('Doublet, linen		', 1, 3, 25, 0),
('Firewood (per day)		', 20, 0.01, 26, 0),
('Fish hook			', 0, 0.1, 27, 0),
('Fishing net (per 25 sq. ft)	', 0, 0.1, 28, 0),
('Flask (leather)		', 0, 0.03, 29, 0),
('Flint and steel		', 0, 1, 30, 0),
('Gloves, kidskin, pair		', 0.5, 3, 31, 0),
('Gown, woolen		', 1, 0.05, 32, 0),
('Gown, linen		', 1, 3, 33, 0),
('Gown, silk		', 1, 50, 34, 0),
('Grappling hook		', 4, 1, 35, 0),
('Hammer (tool, not war)	', 2, 0.5, 36, 0),
('Holy symbol, silver		', 1, 25, 37, 0),
('Holy symbol, pewter		', 1, 5, 38, 0),
('Holy symbol, wooden	', 1, 0.6, 39, 0),
('Horse, cart		', 0, 15, 40, 0),
('Horse, nag		', 0, 8, 41, 0),
('Horse, palfrey		', 0, 40, 42, 0),
('Horse, rouncey		', 0, 25, 43, 0),
('Horse, war, heavy		', 0, 500, 44, 0),
('Horse, war, light		', 0, 200, 45, 0),
('Horse, war, medium		', 0, 350, 46, 0),
('Hose			', 0, 1, 47, 0),
('Iron spikes, dozen		', 0, 1, 48, 0),
('Ladder (per 10ft)		', 20, 0.5, 49, 0),
('Lamp (bronze)		', 1, 0.1, 50, 0),
('Lantern, bullseye		', 3, 12, 51, 0),
('Lantern, hooded		', 2, 7, 52, 0),
('Lock			', 1, 20, 53, 0),
('Manacles			', 2, 15, 54, 0),
('Mirror (small steel)		', 0.5, 20, 55, 0),
('Mirror (small silver)		', 0.5, 45, 56, 0),
('Mule			', 0, 18, 57, 0),
('Musical instrument		', 1, 5, 58, 0),
('Needle and thread		', 0, 0.03, 59, 0),
('Oil (lamp) (per pint)		', 1, 0.1, 60, 0),
('Ox			', 0, 15, 61, 0),
('Parchment (per sheet)	', 0, 0.2, 62, 0),
('Pin (cloak)		', 0, 0.4, 63, 0),
('Piton			', 0.5, 0.1, 64, 0),
('Pole (per 10 ft)		', 8, 0.2, 65, 0),
('Pony			', 0, 12, 66, 0),
('Pot, iron			', 10, 0.5, 67, 0),
('Pouch, belt, large		', 2, 0.4, 68, 0),
('Pouch, belt, small		', 1, 0.2, 69, 0),
('Quill (pen)			', 0, 0.1, 70, 0),
('Quiver (holds 12 arrows)	', 1, 1, 71, 0),
('Quiver (holds 24 arrows)	', 2, 0.25, 72, 0),
('Quiver (holds 12 bolts)	', 1, 0.12, 73, 0),
('Quiver (holds 24 bolts)	', 2, 3, 74, 0),
('Rations, standard (per day)	', 2, 2, 75, 0),
('Rations, trail (per day)	', 1, 6, 76, 0),
('Reins, bit and bridle		', 5, 2, 77, 0),
('Robe, linen		', 1, 3, 78, 0),
('Robe, silk			', 1, 60, 79, 0),
('Rope, hemp (per 50 ft)	', 10, 1, 80, 0),
('Rope, silk (per 50 ft)		', 5, 10, 81, 0),
('Sack, small		', 0.5, 0.09, 82, 0),
('Sack, large		', 1, 0.15, 83, 0),
('Saddle and stirrups		', 20, 10, 84, 0),
('Satchel			', 5, 1, 85, 0),
('Scrollcase, bone		', 0.5, 4, 86, 0),
('Scrollcase, leather		', 0.5, 1, 87, 0),
('Shoes, common		', 1, 0.5, 88, 0),
('Shoes, noble		', 1, 30, 89, 0),
('Shovel			', 8, 2, 90, 0),
('Signal Whistle		', 0, 0.8, 91, 0),
('Skillet			', 5, 1, 92, 0),
('Soap (per lb)		', 1, 0.5, 93, 0),
('Spell book (blank)		', 5, 25, 94, 0),
('Tent			', 20, 10, 95, 0),
('Thieves'' Tools		', 1, 30, 96, 0),
('Torch			', 1, 0.01, 97, 0),
('Tunic, woolen		', 1, 0.05, 98, 0),
('Tunic, banqueting		', 1, 10, 99, 0),
('Twine, linen (per 100 ft)	', 0.5, 0.08, 100, 0),
('Vellum (per sheet)		', 0, 0.3, 101, 0),
('Wagon, small		', 0, 100, 102, 0),
('Wagon, large		', 0, 250, 103, 0),
('Water,  holy (per vial)	', 0.5, 25, 104, 0),
('Waterskin			', 1, 1, 105, 0),
('Whetstone		', 0.5, 0.02, 106, 0),
('Wine, pint			', 1, 0.05, 107, 0),
('Banded armour', 35, 90, 108, 1),
('Mail hauberk or byrnie (chain)', 30, 75, 109, 1),
('Mail, elfin (chain)', 15, -1, 110, 1),
('Leather armour', 15, 5, 111, 1),
('Padded gambeson armour', 10, 4, 112, 1),
('Plate armour', 45, 400, 113, 1),
('Ring armour', 35, 30, 114, 1),
('Scale or lamellar armour', 40, 45, 115, 1),
('Shield, large', 10, 15, 116, 1),
('Shield, medium', 8, 12, 117, 1),
('Shield, small', 5, 10, 118, 1),
('Splint Armour', 40, 80, 119, 1),
('Studded Armour', 20, 15, 120, 1),
('Arrows', 0.333333, 0.166667, 121, 2),
('Axe, battle', 7, 5, 122, 2),
('Axe, hand', 5, 1, 123, 2),
('Bolt, heavy crossbow', 0.333333, 0.333333, 124, 2),
('Bolt, light crossbow', 0.166667, 0.166667, 125, 2),
('Club', 3, 0.02, 126, 2),
('Dagger', 1, 2, 127, 2),
('Dart', 0.5, 0.2, 128, 2),
('Flail, heavy', 10, 3, 129, 2),
('Flail, light', 4, 6, 130, 2),
('Halberd', 18, 9, 131, 2),
('Hammer, war, heavy', 10, 7, 132, 2),
('Hammer, war, light', 5, 1, 133, 2),
('Javelin', 4, 0.5, 134, 2),
('Lance', 15, 6, 135, 2),
('Mace, heavy', 10, 10, 136, 2),
('Mace, light', 5, 4, 137, 2),
('Morning star', 12, 5, 138, 2),
('Pick, heavy', 10, 8, 139, 2),
('Pick, light', 4, 5, 140, 2),
('Pole arm', 8, 6, 141, 2),
('Sling bullet', 0.333333, 0.083333, 142, 2),
('Sling stone', 0.166667, 0, 143, 2),
('Spear', 5, 1, 144, 2),
('Staff', 5, 0, 145, 2),
('Sword, claymore/bastard', 10, 25, 146, 2),
('Sword, broad', 8, 10, 147, 2),
('Sword, long', 7, 15, 148, 2),
('Sword, scimitar', 5, 15, 149, 2),
('Sword, short', 3, 8, 150, 2),
('Sword, two-handed', 25, 30, 151, 2),
('Trident', 5, 4, 152, 2),
('Bow, long', 12, 60, 153, 2),
('Bow, short', 8, 15, 154, 2),
('Composite bow, long', 13, 100, 155, 2),
('Composite bow, short', 9, 75, 156, 2),
('Crossbow, heavy', 12, 20, 157, 2),
('Crossbow, light', 4, 12, 158, 2),
('Sling', 0.5, 0.5, 159, 2);
